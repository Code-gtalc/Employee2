...
<%@ page import="static net.sf.jasperreports.export.type.HtmlSizeUnitEnum.POINT" %>
...
<%
    ...
    try {
        ...
        SimpleHtmlExporterOutput output = new SimpleHtmlExporterOutput(response.getOutputStream());
        ...
        // Flush the output stream to send the report in chunks as it's being generated
